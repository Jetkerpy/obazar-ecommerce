...
SECRET_KEY = os.environ.get("SECRET_KEY", "cool")
...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "cool@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "cool")
EMAIL_USE_TLS = True
EMAIL_PORT = 587
# END SETUP EMAIL GOOGLE 

# PAYMENT KEYS ID
PUBLISHABLE_KEY = os.environ.get("PUBLISHABLE_KEY", "cool")
PAYMENT_SECRET_KEY = os.environ.get("PAYMENT_SECRET_KEY", "cool")
STRIPE_ENDPOINT_SECRET = os.environ.get("STRIPE_ENDPOINT_SECRET", "cool")
# END PAYMENT KEYS ID
...
ALGOLIA = {
    'APPLICATION_ID': os.environ.get("APPLICATION_ID", "cool"),
    'API_KEY': os.environ.get("API_KEY", "cool"),
    'INDEX_PREFIX': os.environ.get("INDEX_PREFIX", "cool")
}
